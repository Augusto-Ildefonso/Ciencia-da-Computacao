...
Ao inserir no meio da lista, teremos um problema de deslocamento dos itens, pois ao colocar o item na posição n, todos os elementos na posição n+1 até o final terão que ser deslocados. O procedimento: achamos a posição (estará ocupada), pegamos o elemento no i e copiamos para o i+1 e assim em diante. Uma dica para fazer isso é começar pelo final e ir até o i+1.