...
~~~
O pior caso do quicksort é $n^2$ e ocorre quando o pivô for o menor ou maior elemento, o primeiro ou último elemento para vetores ordenados, ou quando todos os elementos são
